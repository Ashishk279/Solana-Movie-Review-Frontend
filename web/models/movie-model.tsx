  ...
  static deserialize(buffer?: Buffer): Movie | null {
    ...
    try {
      const { title, rating, description } =
        ...
        // let offset = 0;
        // const initialized = buffer.readInt8(offset);
        // offset++;
        // const rating = buffer.readInt8(offset);
        // offset++;
        // const titleLength= buffer.readInt32LE(offset);
        // offset+=4;
        // const title = new String(buffer.slice(offset, offset+titleLength));
        // offset+=titleLength;
        // const descriptionLenth = buffer.readInt32LE(offset)
        // offset+=4;
        // const description = new String(buffer.slice(offset, offset+ descriptionLenth))
